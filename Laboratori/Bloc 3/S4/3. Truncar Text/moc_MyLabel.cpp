...
QT_MOC_LITERAL(1, 8, 9), // "enviaText"
QT_MOC_LITERAL(2, 18, 0), // ""
QT_MOC_LITERAL(3, 19, 7), // "Truncar"
QT_MOC_LITERAL(4, 27, 11) // "SetOriginal"

    },
    "MyLabel\0enviaText\0\0Truncar\0SetOriginal"
};
...
void MyLabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyLabel::enviaText)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyLabel::enviaText(const QString & _t1)
{
