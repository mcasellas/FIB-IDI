...
QT_MOC_LITERAL(1, 11, 15), // "actualitzaBarra"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 6), // "slider"
QT_MOC_LITERAL(4, 35, 11) // "aplicarZoom"

    },
    "MyGLWidget\0actualitzaBarra\0\0slider\0"
    "aplicarZoom"
};
...
void MyGLWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->actualitzaBarra((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->aplicarZoom((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyGLWidget::actualitzaBarra)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyGLWidget::actualitzaBarra(int _t1)
{
