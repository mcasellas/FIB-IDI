...
public:
    ...
    void setupUi(QWidget *MyForm)
    {
        ...
        QObject::connect(verticalSlider, SIGNAL(valueChanged(int)), widget, SLOT(setValor(int)));
        QObject::connect(widget, SIGNAL(actualitzarAngle(int)), verticalSlider, SLOT(setValue(int)));
