...
void MyGLWidget::createBuffers ()
{
  ...
  Vertices[6] = glm::vec3(-0.4, 0.4, 0.0);
  Vertices[7] = glm::vec3(0.4, 0.4, 0.0);
  Vertices[8] = glm::vec3(0.0, 0.8, 0.0);

  glm::vec3 Vertices2[3];  // Tres vèrtexs amb X, Y i Z
  Vertices2[0] = glm::vec3(0.6, -0.2, 0.0);
  Vertices2[1] = glm::vec3(0.6, -0.4, 0.0);
  Vertices2[2] = glm::vec3(0.8, -0.4, 0.0);
