...
QT_MOC_LITERAL(1, 11, 16), // "actualitzarAngle"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 3), // "ang"
QT_MOC_LITERAL(4, 33, 8), // "setValor"
QT_MOC_LITERAL(5, 42, 3) // "val"

    },
    "MyGLWidget\0actualitzarAngle\0\0ang\0"
    "setValor\0val"
};
...
void MyGLWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->actualitzarAngle((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->setValor((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyGLWidget::actualitzarAngle)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyGLWidget::actualitzarAngle(int _t1)
{
