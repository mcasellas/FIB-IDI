...
QT_MOC_LITERAL(1, 8, 11), // "activaCheck"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 11), // "assignaZero"
QT_MOC_LITERAL(4, 33, 13), // "activarAlarma"
QT_MOC_LITERAL(5, 47, 16), // "desactivarAlarma"
QT_MOC_LITERAL(6, 64, 9), // "rebreHora"
QT_MOC_LITERAL(7, 74, 10), // "rebreMinut"
QT_MOC_LITERAL(8, 85, 5) // "reset"

    },
    "MyLabel\0activaCheck\0\0assignaZero\0"
    "activarAlarma\0desactivarAlarma\0rebreHora\0"
    "rebreMinut\0reset"
};
...
void MyLabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->activaCheck((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 1: _t->assignaZero((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 2: _t->activarAlarma(); break;
        case 3: _t->desactivarAlarma(); break;
        case 4: _t->rebreHora((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 5: _t->rebreMinut((*reinterpret_cast< int(*)>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyLabel::activaCheck)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyLabel::assignaZero)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void MyLabel::activaCheck(bool _t1)
{
...
// SIGNAL 1
void MyLabel::assignaZero(QString _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
