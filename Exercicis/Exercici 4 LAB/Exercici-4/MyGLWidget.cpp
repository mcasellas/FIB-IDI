...
{
    EscenaMin = glm::vec3(-1.0f, 0.0f, -1.0f);
    EscenaMax = glm::vec3(1.0f, 2.0f, 1.0f);
    ...
    std::cout << CentreESC.x << ", " << CentreESC.y << ", " << CentreESC.z << std::endl;
...
void MyGLWidget::paintGL ()
{
    ...
    // Activem el VAO per a pintar els Patricio
